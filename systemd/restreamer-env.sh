...
echo ARM_VERSION=$ARM_VERSION > /etc/restreamer.env
...
echo RESTREAMER_HTTP_PORT=$RESTREAMER_HTTP_PORT >> /etc/restreamer.env
echo RESTREAMER_MODE=$RESTREAMER_MODE >> /etc/restreamer.env
echo RESTREAMER_SNAPSHOT_REFRESH_INTERVAL=$RESTREAMER_SNAPSHOT_REFRESH_INTERVAL >> /etc/restreamer.env
